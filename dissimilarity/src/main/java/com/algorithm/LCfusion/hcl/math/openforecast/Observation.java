//
package com.algorithm.LCfusion.hcl.math.openforecast;//  OpenForecast - open source, general-purpose forecasting package.
...
public class Observation implements DataPoint
{
    ...
    public void setIndependentValue( String name, double value )
    {
       ...
       // System.out.println( independentValues.get(name));
    }
