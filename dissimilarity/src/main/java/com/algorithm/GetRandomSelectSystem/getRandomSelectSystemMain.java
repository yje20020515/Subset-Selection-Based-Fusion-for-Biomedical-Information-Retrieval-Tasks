package com.algorithm.GetRandomSelectSystem;
...
public class getRandomSelectSystemMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String allRunPath = "E:\\TRECDateset\\TRECDateset\\paperExperiment\\ideaThree\\2020Health\\Adhoc\\standard_input\\";
        String[] AllFusionNames = getAllFusionNames(allRunPath);
        String[] fusionNames = null;

        for (int Num = StartNum; Num <= EndNum ; Num++) {
            String outputPath ="D:\\TRECDateset\\methode_qrel012\\BigExperiment\\2011MB\\Adhoc\\classification\\"+Num;
