...
public class readALL {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int NUM = StartNum; NUM <= EndNum ; NUM++) {
            ...
            String evalPath="D:\\TREC数据集文件\\methode_qrel012\\BigExperiment\\2011MB\\Adhoc\\fusion8\\eval\\ALL\\"+NUM+"\\";
            ...
            /*String evalPath="D:\\TREC数据集文件\\methode_qrel012\\BigExperiment\\2012MB\\Adhoc\\eval\\all\\";
            int excNum = new File(evalPath).listFiles().length;
