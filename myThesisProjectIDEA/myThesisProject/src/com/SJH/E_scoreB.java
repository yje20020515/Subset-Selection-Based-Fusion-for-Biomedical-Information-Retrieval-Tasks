...
public class E_scoreB {
    public static void main(String[] args) throws IOException {
        for (int n = 1; n <=40 ; n++) {
            ...
            BufferedReader br=new BufferedReader(new FileReader("E:\\TREC 数据集\\2020MedicineTrackScientific\\A_Score\\NEW8\\"+n));
            String line="";
    ...
    private static void searchMaxScore(LinkedHashMap<String, Double> lhm,int n) throws IOException {
        ...
        BufferedWriter bw=new BufferedWriter(new FileWriter("E:\\TREC 数据集\\2020MedicineTrackScientific\\A_Score\\NEW8\\score"+n,true));
