package com.LCfusion.LC;

import com.LCfusion.dataStruct.BinaryTree;
import com.LCfusion.dataStruct.BinaryTreeNode;
import com.LCfusion.dataStruct.QrelsList;
import com.LCfusion.dataStruct.QrelsList.QrelsNote;
import com.LCfusion.dataStruct.result;
import com.LCfusion.dataStruct.TreeByAttribute;
...
public class LC {
	...
	public static Hashtable<String, Integer> setSystem(String rawinput) throws IOException{
		...
		for(int i=0;i<files.length;i++){
			...
			//System.err.print("ϵͳ����:"+sysname+"\tϵͳ��õĹ�ϣֵ:"+i+"\n");
			reader.close();
		}
		return systems;
	}
	...
	public static ResultList getResultList(BufferedReader reader,int sid,boolean isrecord) throws IOException{
		...
		StringTokenizer tokenizer=new StringTokenizer(bufferline[sid]);//���ڷָ��ַ���
		//����topic
		int topic=Integer.parseInt(tokenizer.nextToken());//��ȡ����ϵͳ��� 
		int currenttopic=topic;
		if(isrecord){//�ж��Ƿ����		
			tokenizer.nextToken();//���˵���Q0��
			String docid=tokenizer.nextToken();//����ĵ�id
			int rank=Integer.parseInt(tokenizer.nextToken());//��ȡ�ĵ�����
			double score=Double.parseDouble(tokenizer.nextToken());//��ȡ�ĵ�����Է���
			String system=tokenizer.nextToken();//��ȡ��ǰ����ϵͳ��
						
			//construct the result list first item
			ResultList rList=new ResultList(topic,system);//������ǰ����еĶ���
			rList.list.add(new result(docid, rank,score));//����ĵ�id ���� ����Է�����Ϣ������
			...
			while((templine=reader.readLine())!=null){//�ж��Ƿ��Ѿ�ִ�е��ļ����
				tokenizer=new StringTokenizer(templine);//����ȡ����һ�м�¼���зָ�
				//System.out.println(templine);
				topic=Integer.parseInt(tokenizer.nextToken());//�ָ��һ�����
				if(topic!=currenttopic){//����ǰ�ı�Ų�ͬ��˵������һ����ѯ�����
					bufferline[sid]=new String(templine);
					break;
				}else{
					tokenizer.nextToken();//�������Q0����������
					docid=tokenizer.nextToken();//��ȡ�ĵ�id
					try {
						rank=Integer.parseInt(tokenizer.nextToken());//��ȡ�ĵ�����
					} catch (Exception e) {
						System.out.println(sid+" "+topic+" "+rank);//����������sid topic rank
					}
					
					score=Double.parseDouble(tokenizer.nextToken());//��ȡ�ĵ�����
					rList.list.add(new result(docid,rank,score));//������б���
				}
			}
			return rList;//���ظö���
		}else{
